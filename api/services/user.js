...
class UserService {
    ...
    login(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user) {
                throw new error_handler_1.default(422, "Username or Password is incorrect");
            }
    ...
    authenticateWithFacebook(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const fbAPIUrl = `${config_1.default.facebook.apiUrl}${config_1.default.facebook.userDatafields.toString()}&access_token=${token}`;
